...
# Usage: ./train_1000_pseudo.sh [gpu_ids] [threshold]
# Trains with pseudo labels for unlabeled data
# 
# Arguments:
...
EXP_NAME="sd15_25_75_steps=1000_pseudo_threshold=${THRESHOLD}"
TRAIN_OUTPUT_DIR="${TRAIN_OUTPUT_BASE_DIR}/${EXP_NAME}"

echo "Running: train 25/75 split 5k datapoints with pseudo labels for unlabeled data, threshold=$THRESHOLD"
