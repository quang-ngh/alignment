CUDA_VISIBLE_DEVICES=0 python generate_pseudo_label.py \
    --input_json "datasets/manifest_high_margin/from_10k_high_margin_25_75/labeled.json" \
    --output_json "datasets/manifest_high_margin/from_10k_high_margin_25_75/pseudo_labeled_qwen.json" \
...
CUDA_VISIBLE_DEVICES=1 python generate_pseudo_label.py \
    --input_json "datasets/manifest_high_margin/from_10k_high_margin_25_75/unlabeled.json" \
    --output_json "datasets/manifest_high_margin/from_10k_high_margin_25_75/pseudo_unlabeled_qwen.json" \
    --image_base_dir "datasets/FiFA-100k-sorted/data/train" \
    --strategy "qwen_vlm" \
    --model_name "./checkpoints/qwen_7b" \
    --batch_size 1 &
