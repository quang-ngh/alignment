...
UNLABEL_PSEUDO_MANIFEST="datasets/manifest_high_margin/from_5k_high_margin_25_75/pseudo_unlabeled_qwen.json"

accelerate launch --config-file "configs/train_sd15_dr_ddp.yaml" train_sd15_dpo_dr_ots.py \
    --mixed_precision "bf16" \
    --pretrained_model_name_or_path "./checkpoints/sd15" \
    --output_dir "training_runs/sd15_dr_ots_high_margin_pseudo_qwen" \
