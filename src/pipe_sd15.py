...
class StableDiffusionPipeline(
    ...
    def __call__(
        ...
        **kwargs,
        ...
        """
        return_steps_latent = kwargs.get("return_all_latents", False)
        if return_steps_latent:
            steps_latents = []
        else:
            steps_latents = None
        ...
        if steps_latents is not None:
            steps_latents.append(latents.clone().detach().cpu())
        ...
        if not return_dict:
            return (image, has_nsfw_concept, steps_latents if return_steps_latent else None)
